    ...
    while(!done)
    {
        ...
        if (redraw && al_is_event_queue_empty(event_queue))
        {
            ...
            while (!beginning)
            {
                ...
                al_draw_text(font, al_map_rgb(0, 0, 255), WIDTH / 2, 500, ALLEGRO_ALIGN_CENTER, "You will have three lives to make it through all three levels, each level gets progressively harder.");
